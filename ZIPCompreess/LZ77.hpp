...
public:
	void Compress(const std::string& fPath) {
		...
		// fOut:压缩后文件、fOutF:写标记的文件，最后要将两个文件组合在一起
		FILE *fOut = fopen("C:/Users/DELL/Desktop/测试/lz77.lzp", "wb");
		FILE *fOutF = fopen("C:/Users/DELL/Desktop/测试/assist.txt", "wb");
		...
		FILE *fInF = fopen("C:/Users/DELL/Desktop/测试/assist.txt", "rb");
		size_t flagSize = 0;
		...
		// 删除临时的标记文件
		if (remove("C:/Users/DELL/Desktop/测试/assist.txt") != 0)
